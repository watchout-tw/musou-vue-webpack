  ...
  cards: [
    ...
    },
    {
      ...
      longAnswer: [
        ...
        {
          type: 'figure',
          content: '例 1：月薪 36,000 元的小明在休息日加班了 5 小時， 修法前可以拿到 1,900 元，修法後改拿 1,150 元，減少 750 元。'
        },
        {
          type: 'figure',
          content: '例 2：月薪 43,200 元的小雅在休息日加班了 3 小時， 修法前可以拿到 1,080 元，修法後改拿 780 元，減少 300 元。'
        }
      ]
    },
    {
    ...
    {
      question: '要累死了，以後每個人下班後八小時就可以繼續上班。'
    },
    {
    ...
    {
      question: '這次修法以後，民進黨立委說的中南部中小企業就可以讓勞工在例假日上班了！'
    },
    {
